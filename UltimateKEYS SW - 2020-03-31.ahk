; UltimateKEYS SW - 2020-03-31.ahk
...
dkCaron.item("Z") := "Ž"  ; Z with caron
dkCaron.item("#") := "ǯ"  ; small letter ezh with caron
dkCaron.item("3") := "Ǯ"  ; capital letter ezh with caron
...
dkRingDotAbove.item("a") := "ȧ"  ; a with dot above
dkRingDotAbove.item("A") := "Ȧ"  ; A with dot above
dkRingDotAbove.item("ä") := "å"  ; a with ring above
dkRingDotAbove.item("Ä") := "Å"  ; A with ring above
...
dkCedillaOgonek.item("W") := "₩"  ; South Korean won
dkCedillaOgonek.item("!") := "–"  ; en dash
dkCedillaOgonek.item("1") := "–"  ; en dash
dkCedillaOgonek.item("@") := "—"  ; em dash
dkCedillaOgonek.item("2") := "—"  ; em dash
dkCedillaOgonek.item("#") := "―"  ; horizontal bar
dkCedillaOgonek.item("3") := "―"  ; horizontal bar
dkCedillaOgonek.item("$") := "‐"  ; hyphen
dkCedillaOgonek.item("4") := "‐"  ; hyphen
dkCedillaOgonek.item("(") := "‒"  ; figure dash
dkCedillaOgonek.item("9") := "‒"  ; figure dash
dkCedillaOgonek.item(")") := "­"  ; soft hyphen
...
dkBreveSpecial.item("#") := "ʒ"  ; small letter ezh
dkBreveSpecial.item("3") := "Ʒ"  ; capital letter ezh
...
dkAcuteAccent.item("*") := "♪"  ; eighth note
...
dkGraveAccent.item("Å") := "₩"  ; South Korean won
dkGraveAccent.item("!") := " "  ; en space
dkGraveAccent.item("@") := " "  ; em space
dkGraveAccent.item("#") := " "  ; three-per-em space
dkGraveAccent.item("3") := " "  ; three-per-em space
dkGraveAccent.item("$") := " "  ; four-per-em space
dkGraveAccent.item("4") := " "  ; four-per-em space
dkGraveAccent.item("%") := " "  ; punctuation space
dkGraveAccent.item("5") := " "  ; punctuation space
dkGraveAccent.item("^") := " "  ; six-per-em space
dkGraveAccent.item("6") := " "  ; six-per-em space
dkGraveAccent.item("&") := " "  ; thin space
dkGraveAccent.item("7") := " "  ; thin space
dkGraveAccent.item("*") := " "  ; hair space
dkGraveAccent.item("8") := " "  ; hair space
dkGraveAccent.item("(") := " "  ; figure space
dkGraveAccent.item("9") := " "  ; figure space
dkGraveAccent.item(")") := "​"   ; zero-width space
dkGraveAccent.item("0") := "​"   ; zero-width space
dkGraveAccent.item("-") := " "  ; non-breaking space
dkGraveAccent.item("1") := " "  ; en quad
dkGraveAccent.item("2") := " "  ; em quad
...
dkNotSign.item("!") := "№"  ; numero sign
dkNotSign.item("1") := "№"  ; numero sign
dkNotSign.item("@") := "½"  ; vulgar fraction 1/2
dkNotSign.item("2") := "½"  ; vulgar fraction 1/2
dkNotSign.item("#") := "⅓"  ; vulgar fraction 1/3
dkNotSign.item("3") := "⅓"  ; vulgar fraction 1/3
dkNotSign.item("$") := "¼"  ; vulgar fraction 1/4
dkNotSign.item("4") := "¼"  ; vulgar fraction 1/4
dkNotSign.item("%") := "⅔"  ; vulgar fraction 2/3
dkNotSign.item("5") := "⅔"  ; vulgar fraction 2/3
dkNotSign.item("^") := "¾"  ; vulgar fraction 3/4
dkNotSign.item("6") := "¾"  ; vulgar fraction 3/4
dkNotSign.item("&") := "⅛"  ; vulgar fraction 1/8
dkNotSign.item("7") := "⅛"  ; vulgar fraction 1/8
dkNotSign.item("*") := "⅜"  ; vulgar fraction 3/8
dkNotSign.item("8") := "⅜"  ; vulgar fraction 3/8
dkNotSign.item("(") := "⅝"  ; vulgar fraction 5/8
dkNotSign.item("9") := "⅝"  ; vulgar fraction 5/8
dkNotSign.item(")") := "⅞"  ; vulgar fraction 7/8
...
dkBrokenBar.item("Z") := "Ȥ"  ; Z with hook
dkBrokenBar.item("!") := "←"  ; leftwards arrow
dkBrokenBar.item("@") := "↓"  ; downwards arrow
dkBrokenBar.item("#") := "↑"  ; upwards arrow
dkBrokenBar.item("$") := "→"  ; rightwards arrow
dkBrokenBar.item("%") := "↖"  ; north west arrow
dkBrokenBar.item("^") := "↙"  ; south west arrow
dkBrokenBar.item("&") := "↗"  ; north east arrow
dkBrokenBar.item("*") := "↘"  ; south east arrow
dkBrokenBar.item("(") := "↕"  ; up down arrow
dkBrokenBar.item(")") := "↨"  ; up down arrow with base
dkBrokenBar.item("=") := "↔"  ; left right arrow
dkBrokenBar.item("1") := "⇐"  ; leftwards double arrow
dkBrokenBar.item("2") := "⇓"  ; downwards double arrow
dkBrokenBar.item("3") := "⇑"  ; upwards double arrow
dkBrokenBar.item("4") := "⇒"  ; rightwards double arrow
dkBrokenBar.item("5") := "⇖"  ; north west double arrow
dkBrokenBar.item("6") := "⇙"  ; south west double arrow
dkBrokenBar.item("7") := "⇗"  ; north east double arrow
dkBrokenBar.item("8") := "⇘"  ; south east double arrow
dkBrokenBar.item("9") := "⇕"  ; up down double arrow
dkBrokenBar.item("0") := "↲"  ; downwards arrow with tip leftwards
...
dkGreekAlphabet.item("!") := "¹"  ; superscript 1
dkGreekAlphabet.item("@") := "²"  ; superscript 2
dkGreekAlphabet.item("#") := "³"  ; superscript 3
dkGreekAlphabet.item("$") := "⁴"  ; superscript 4
dkGreekAlphabet.item("%") := "⁵"  ; superscript 5
dkGreekAlphabet.item("^") := "⁶"  ; superscript 6
dkGreekAlphabet.item("&") := "⁷"  ; superscript 7
dkGreekAlphabet.item("*") := "⁸"  ; superscript 8
dkGreekAlphabet.item("(") := "⁹"  ; superscript 9
dkGreekAlphabet.item(")") := "⁰"  ; superscript 0
dkGreekAlphabet.item("-") := "⁻"  ; superscript -
dkGreekAlphabet.item("=") := "⁼"  ; superscript =
dkGreekAlphabet.item("+") := "⁺"  ; superscript +
dkGreekAlphabet.item("[") := "⁽"  ; superscript (
dkGreekAlphabet.item("]") := "⁾"  ; superscript )
dkGreekAlphabet.item("1") := "₁"  ; subscript 1
dkGreekAlphabet.item("2") := "₂"  ; subscript 2
dkGreekAlphabet.item("3") := "₃"  ; subscript 3
dkGreekAlphabet.item("4") := "₄"  ; subscript 4
dkGreekAlphabet.item("5") := "₅"  ; subscript 5
dkGreekAlphabet.item("6") := "₆"  ; subscript 6
dkGreekAlphabet.item("7") := "₇"  ; subscript 7
dkGreekAlphabet.item("8") := "₈"  ; subscript 8
dkGreekAlphabet.item("9") := "₉"  ; subscript 9
dkGreekAlphabet.item("0") := "₀"  ; subscript 0
...
dkMathSymbols.item("#") := "∛"  ; cube root
dkMathSymbols.item("3") := "∛"  ; cube root
dkMathSymbols.item("$") := "∜"  ; fourth root
dkMathSymbols.item("4") := "∜"  ; fourth root
dkMathSymbols.item("%") := "‰"  ; per mille sign
dkMathSymbols.item("5") := "‱" ; per ten thousand sign
...
dkMathSymbols.item("(") := "∟"  ; right angle
dkMathSymbols.item("9") := "∟"  ; right angle
dkMathSymbols.item(")") := "∠"  ; angle symbol
