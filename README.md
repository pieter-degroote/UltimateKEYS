...
International US QWERTY layout with AltGr (Right Alt) dead keys via AutoHotkey (Win), MSKLC (Win, experimental) and XKB integration (Linux, experimental). Derived from EurKEY (by Steffen Br&uuml;ntjen).
