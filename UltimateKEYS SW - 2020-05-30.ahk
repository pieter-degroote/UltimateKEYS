; UltimateKEYS SW - 2020-05-30.ahk
...
dkCaron.item[chr(0x00e4)] := "{u+00e2}"  ; (ä -> â) a with circumflex
dkCaron.item[chr(0x00c4)] := "{u+00c2}"  ; (Ä -> Â) A with circumflex
dkCaron.item[chr(0x00eb)] := "{u+00ea}"  ; (ë -> ê) e with circumflex
dkCaron.item[chr(0x00cb)] := "{u+00ca}"  ; (Ë -> Ê) E with circumflex
dkCaron.item[chr(0x00ef)] := "{u+00ee}"  ; (ï -> î) i with circumflex
dkCaron.item[chr(0x00cf)] := "{u+00ce}"  ; (Ï -> Î) I with circumflex
dkCaron.item[chr(0x00f6)] := "{u+00f4}"  ; (ö -> ô) o with circumflex
dkCaron.item[chr(0x00d6)] := "{u+00d4}"  ; (Ö -> Ô) O with circumflex
dkCaron.item[chr(0x00fc)] := "{u+00fb}"  ; (ü -> û) u with circumflex
...
dkNotSign.item[chr(0x00b6)] := "{u+2e2e}"  ; (¶ -> ⸮) reversed question mark
