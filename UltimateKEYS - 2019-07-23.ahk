...
dkCaronBreve.item("a") := "ă"  ; a with breve
dkCaronBreve.item("A") := "Ă"  ; A with breve

dkCaronBreve.item("ä") := "ǎ"  ; a with caron
dkCaronBreve.item("Ä") := "Ǎ"  ; A with caron
dkCaronBreve.item("c") := "č"  ; c with caron
dkCaronBreve.item("C") := "Č"  ; C with caron
dkCaronBreve.item("d") := "ď"  ; d with caron
dkCaronBreve.item("D") := "Ď"  ; D with caron

dkCaronBreve.item("e") := "ĕ"  ; e with breve
dkCaronBreve.item("E") := "Ĕ"  ; E with breve

dkCaronBreve.item("ë") := "ě"  ; e with caron
dkCaronBreve.item("Ë") := "Ě"  ; E with caron

dkCaronBreve.item("g") := "ğ"  ; g with breve
dkCaronBreve.item("G") := "Ğ"  ; G with breve

dkCaronBreve.item("é") := "ǧ"  ; g with caron
dkCaronBreve.item("É") := "Ǧ"  ; G with caron
dkCaronBreve.item("h") := "ȟ"  ; h with caron
dkCaronBreve.item("H") := "Ȟ"  ; H with caron

dkCaronBreve.item("i") := "ĭ"  ; i with breve
dkCaronBreve.item("I") := "Ĭ"  ; I with breve

dkCaronBreve.item("ï") := "ǐ"  ; i with caron
dkCaronBreve.item("Ï") := "Ǐ"  ; I with caron
dkCaronBreve.item("j") := "ǰ"  ; j with caron
dkCaronBreve.item("k") := "ǩ"  ; k with caron
dkCaronBreve.item("K") := "Ǩ"  ; K with caron
dkCaronBreve.item("l") := "ľ"  ; l with caron
dkCaronBreve.item("L") := "Ľ"  ; L with caron
dkCaronBreve.item("n") := "ň"  ; n with caron
dkCaronBreve.item("N") := "Ň"  ; N with caron

dkCaronBreve.item("o") := "ŏ"  ; o with breve
dkCaronBreve.item("O") := "Ŏ"  ; O with breve

dkCaronBreve.item("ö") := "ǒ"  ; o with caron
dkCaronBreve.item("Ö") := "Ǒ"  ; O with caron
dkCaronBreve.item("r") := "ř"  ; r with caron
dkCaronBreve.item("R") := "Ř"  ; R with caron
dkCaronBreve.item("s") := "š"  ; s with caron
dkCaronBreve.item("S") := "Š"  ; S with caron
dkCaronBreve.item("t") := "ť"  ; t with caron
dkCaronBreve.item("T") := "Ť"  ; T with caron

dkCaronBreve.item("u") := "ŭ"  ; u with breve
dkCaronBreve.item("U") := "Ŭ"  ; U with breve

dkCaronBreve.item("ü") := "ǔ"  ; u with caron
dkCaronBreve.item("Ü") := "Ǔ"  ; U with caron
dkCaronBreve.item("z") := "ž"  ; z with caron
dkCaronBreve.item("Z") := "Ž"  ; Z with caron

dkCaronBreve.item(".") := "˘"  ; breve
dkCaronBreve.item(" ") := "ˇ"  ; caron
...
dkRingDotAbove.item("E") := "Ė"  ; E with dot above
dkRingDotAbove.item("ë") := "ə"  ; small letter schwa (Azerbaijani)
dkRingDotAbove.item("Ë") := "Ə"  ; capital letter schwa (Azerbaijani)
...
dkAcuteAccent.item("E") := "É"  ; E with acute
dkAcuteAccent.item("ë") := "ə"  ; small letter schwa (Azerbaijani)
dkAcuteAccent.item("Ë") := "Ə"  ; capital letter schwa (Azerbaijani)
...
dkGraveAccent.item("O") := "Ò"  ; O with grave
dkGraveAccent.item("s") := "ș"  ; s with comma below (Romanian)
dkGraveAccent.item("S") := "Ș"  ; S with comma below (Romanian)
dkGraveAccent.item("t") := "ț"  ; t with comma below (Romanian)
dkGraveAccent.item("T") := "Ț"  ; T with comma below (Romanian)
...
dkTilde.item("O") := "Õ"  ; O with tilde
dkTilde.item("s") := "ș"  ; s with comma below (Romanian)
dkTilde.item("S") := "Ș"  ; S with comma below (Romanian)
dkTilde.item("t") := "ț"  ; t with comma below (Romanian)
dkTilde.item("T") := "Ț"  ; T with comma below (Romanian)
...
dkCedillaOgonek.item("ß") := "ș"  ; s with comma below (Romanian)
dkCedillaOgonek.item("ẞ") := "Ș"  ; S with comma below (Romanian)
dkCedillaOgonek.item("þ") := "ț"  ; t with comma below (Romanian)
dkCedillaOgonek.item("Þ") := "Ț"  ; T with comma below (Romanian)
