...
dkBreveSpecial.item("G") := "Ğ"  ; G with breve
dkBreveSpecial.item("é") := "ɣ"  ; latin small gamma
dkBreveSpecial.item("É") := "Ɣ"  ; latin capital gamma
...
dkBreveSpecial.item("S") := "Ș"  ; S with comma below (Romanian)
dkBreveSpecial.item("ß") := "ʃ"  ; small letter esh
dkBreveSpecial.item("ẞ") := "Ʃ"  ; capital letter esh
...
; Dead Key :  Diaeresis and Hook

dkDiaeresis := ComObjCreate("Scripting.Dictionary")
dkDiaeresis.item("a") := "ä"  ; a with diaeresis
dkDiaeresis.item("A") := "Ä"  ; A with diaeresis
dkDiaeresis.item("b") := "ɓ"  ; b with hook
dkDiaeresis.item("B") := "Ɓ"  ; B with hook
dkDiaeresis.item("c") := "ƈ"  ; c with hook
dkDiaeresis.item("C") := "Ƈ"  ; C with hook
dkDiaeresis.item("d") := "ɗ"  ; d with hook
dkDiaeresis.item("D") := "Ɗ"  ; D with hook
dkDiaeresis.item("e") := "ë"  ; e with diaeresis
dkDiaeresis.item("E") := "Ë"  ; E with diaeresis
dkDiaeresis.item("ë") := "ɛ"  ; small open e (latin small epsilon)
dkDiaeresis.item("Ë") := "Ɛ"  ; capital open E (latin capital epsilon)
dkDiaeresis.item("f") := "ƒ"  ; f with hook
dkDiaeresis.item("F") := "Ƒ"  ; F with hook
dkDiaeresis.item("g") := "ɠ"  ; g with hook
dkDiaeresis.item("G") := "Ɠ"  ; G with hook
dkDiaeresis.item("h") := "ḧ"  ; h with diaeresis
dkDiaeresis.item("H") := "Ḧ"  ; H with diaeresis
dkDiaeresis.item("i") := "ï"  ; i with diaeresis
dkDiaeresis.item("I") := "Ï"  ; I with diaeresis
dkDiaeresis.item("k") := "ƙ"  ; k with hook
dkDiaeresis.item("K") := "Ƙ"  ; K with hook
dkDiaeresis.item("o") := "ö"  ; o with diaeresis
dkDiaeresis.item("O") := "Ö"  ; O with diaeresis
dkDiaeresis.item("ö") := "ơ"  ; o with horn
dkDiaeresis.item("Ö") := "Ơ"  ; O with horn
dkDiaeresis.item("p") := "ƥ"  ; p with hook
dkDiaeresis.item("P") := "Ƥ"  ; P with hook
dkDiaeresis.item("s") := "ſ"  ; small long s
dkDiaeresis.item("t") := "ẗ"  ; t with diaeresis
dkDiaeresis.item("þ") := "ƭ"  ; t with hook
dkDiaeresis.item("Þ") := "Ƭ"  ; T with hook
dkDiaeresis.item("u") := "ü"  ; u with diaeresis
dkDiaeresis.item("U") := "Ü"  ; U with diaeresis
dkDiaeresis.item("ü") := "ư"  ; u with horn
dkDiaeresis.item("Ü") := "Ư"  ; U with horn
dkDiaeresis.item("v") := "ʋ"  ; v with hook
dkDiaeresis.item("V") := "Ʋ"  ; V with hook
...
dkDiaeresis.item("Y") := "Ÿ"  ; Y with diaeresis
dkDiaeresis.item("ÿ") := "ƴ"  ; y with hook
dkDiaeresis.item("Ÿ") := "Ƴ"  ; Y with hook
dkDiaeresis.item("z") := "ȥ"  ; z with hook
dkDiaeresis.item("Z") := "Ȥ"  ; Z with hook
