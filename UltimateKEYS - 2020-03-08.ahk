...
dkMacron.item("G") := "Ḡ"  ; G with macron
dkMacron.item("é") := "ǥ"  ; g with stroke (Skolt Sami)
dkMacron.item("É") := "Ǥ"  ; G with stroke (Skolt Sami)
dkMacron.item("h") := "ħ"  ; h with stroke (Maltese)
dkMacron.item("H") := "Ħ"  ; H with stroke (Maltese)
...
dkBreveSpecial.item("U") := "Ŭ"  ; U with breve
dkBreveSpecial.item("ü") := "ʊ"  ; latin small letter upsilon
dkBreveSpecial.item("Ü") := "Ʊ"  ; latin capital letter upsilon
...
dkGraveAccent.item("5") := " "  ; six-per-em space
dkGraveAccent.item("6") := " "  ; punctuation space
dkGraveAccent.item("7") := " "  ; en quad
...
dkBrokenBar.item("G") := "Ɠ"  ; G with hook
dkBrokenBar.item("h") := "❦"  ; floral heart
dkBrokenBar.item("H") := "❧"  ; rotated floral heart bullet
