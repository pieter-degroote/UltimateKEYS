; UltimateKEYS SW - 2020-11-28.ahk
...
dkDiaeresis.item[chr(0x00df)] := "{u+017f}"  ; (ß -> ſ) small long s
...
dkMathSymbols.item[chr(0x00f6)] := "{u+2299}"  ; (ö -> ⊙) circled dot operator
dkMathSymbols.item[chr(0x00d6)] := "{u+229a}"  ; (Ö -> ⊚) circled ring operator
