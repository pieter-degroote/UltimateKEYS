; UltimateKEYS SW - 2020-04-23.ahk
...
dkAcuteAccent.item("#") := "⁂"  ; asterism
dkAcuteAccent.item("3") := "⁂"  ; asterism
dkAcuteAccent.item("$") := "★"  ; black star
dkAcuteAccent.item("4") := "★"  ; black star
dkAcuteAccent.item("%") := "☆"  ; white star
dkAcuteAccent.item("5") := "☆"  ; white star
dkAcuteAccent.item("^") := "✽"  ; heavy teardrop-spoked asterisk
dkAcuteAccent.item("6") := "✽"  ; heavy teardrop-spoked asterisk
dkAcuteAccent.item("&") := "✻"  ; teardrop-spoked asterisk
...
dkNotSign.item("!") := "←"  ; leftwards arrow
dkNotSign.item("@") := "↓"  ; downwards arrow
dkNotSign.item("#") := "↑"  ; upwards arrow
dkNotSign.item("$") := "→"  ; rightwards arrow
dkNotSign.item("%") := "↖"  ; north west arrow
dkNotSign.item("^") := "↙"  ; south west arrow
dkNotSign.item("&") := "↗"  ; north east arrow
dkNotSign.item("*") := "↘"  ; south east arrow
dkNotSign.item("(") := "↕"  ; up down arrow
dkNotSign.item(")") := "↨"  ; up down arrow with base
...
dkNotSign.item("0") := "↲"  ; downwards arrow with tip leftwards
...
dkBrokenBar.item("Z") := "Ȥ"  ; Z with hook
dkBrokenBar.item("!") := "№"  ; numero sign
dkBrokenBar.item("1") := "№"  ; numero sign
dkBrokenBar.item("@") := "½"  ; vulgar fraction 1/2
dkBrokenBar.item("2") := "½"  ; vulgar fraction 1/2
dkBrokenBar.item("#") := "⅓"  ; vulgar fraction 1/3
dkBrokenBar.item("3") := "⅓"  ; vulgar fraction 1/3
dkBrokenBar.item("$") := "¼"  ; vulgar fraction 1/4
dkBrokenBar.item("4") := "¼"  ; vulgar fraction 1/4
dkBrokenBar.item("%") := "⅔"  ; vulgar fraction 2/3
dkBrokenBar.item("5") := "⅔"  ; vulgar fraction 2/3
dkBrokenBar.item("^") := "¾"  ; vulgar fraction 3/4
dkBrokenBar.item("6") := "¾"  ; vulgar fraction 3/4
dkBrokenBar.item("&") := "⅛"  ; vulgar fraction 1/8
dkBrokenBar.item("7") := "⅛"  ; vulgar fraction 1/8
dkBrokenBar.item("*") := "⅜"  ; vulgar fraction 3/8
dkBrokenBar.item("8") := "⅜"  ; vulgar fraction 3/8
dkBrokenBar.item("(") := "⅝"  ; vulgar fraction 5/8
dkBrokenBar.item("9") := "⅝"  ; vulgar fraction 5/8
dkBrokenBar.item(")") := "⅞"  ; vulgar fraction 7/8
