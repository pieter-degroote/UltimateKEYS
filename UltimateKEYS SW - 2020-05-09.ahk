; UltimateKEYS SW - 2020-05-09.ahk
...
dkCaron.item("ü") := "ǚ"  ; (u+01da) u with diaeresis and caron
dkCaron.item("Ü") := "Ǚ"  ; (u+01d9) U with diaeresis and caron
...
dkGreekAlphabet.item("o") := "ο"  ; (u+03bf) small omikron
dkGreekAlphabet.item("O") := "Ο"  ; (u+039f) capital omikron
